...
public class Consola {
    ...
    public void mostrarMenuComercio(int costoAtaque, int costoDefensa, int mejorasRestantesAtaque, int mejorasRestantesDefensa, boolean puedeMejorarAtaque, boolean puedeMejorarDefensa) {
        ...
        System.out.println("═══════════════════════════════════════════════════════");
        System.out.println(" [1] Comprar tickets (15 de oro → 3 tickets)");
        System.out.println(" [2] Misión (pregunta) - Gana oro si aciertas");
        System.out.println(" [3] Mejorar ataque (" + costoAtaque + " de oro → +1 ataque permanente, quedan " + mejorasRestantesAtaque + " mejora(s)" + (puedeMejorarAtaque ? "" : " - máximo alcanzado") + ")");
        System.out.println(" [4] Mejorar defensa (" + costoDefensa + " de oro → +1 defensa permanente, quedan " + mejorasRestantesDefensa + " mejora(s)" + (puedeMejorarDefensa ? "" : " - máximo alcanzado") + ")");
    ...
    public void mostrarEstadoJugador(Jugador jugador, String civilizacionActual, Grafo grafo) {
        ...
        System.out.println("╚══════════════════════════════════════════════════════╝");
        System.out.println("🌍 Civilización actual: " + civilizacionActual);
        System.out.println("💰 Oro: " + jugador.getOro() + "/200");
        System.out.println("🎫 Tickets: " + jugador.getTickets() + "/30");
        System.out.println("👥 Población: " + jugador.getPoblacion() + "/" + jugador.getMaxPoblacion());
        System.out.println("🏛️ Maravillas recolectadas: " + jugador.getMaravillasCount() + "/36");
        ...
        if (bonifAtaque > 0) System.out.println("   ⚔️ +" + (int)bonifAtaque + "% de ataque");
        if (bonifDefensa > 0) System.out.println("   🛡️ +" + (int)bonifDefensa + "% de defensa");
        if (bonifAtaque == 0 && bonifDefensa == 0) System.out.println("   ❌ Ningún beneficio activo");
    ...
    public void mostrarEstadisticasDetalladas(Jugador jugador) {
        ...
        System.out.println("🎫 Tickets: " + jugador.getTickets() + "/30");
        System.out.println("👥 Población: " + jugador.getPoblacion() + "/" + jugador.getMaxPoblacion());
        System.out.println("🏛️ Maravillas: " + jugador.getMaravillasCount() + "/36");
        
        System.out.println("\n⚔️ Ataque total: " + combate.Estadisticas.getAtaqueTotal(jugador));
        System.out.println("🛡️ Defensa total: " + combate.Estadisticas.getDefensaTotal(jugador));
    ...
    public void mostrarResultadoBatalla(combate.Batalla.Resultado resultado, String ciudadNombre) {
        System.out.println("\n╔══════════════════════════════════════════════════════╗");
        System.out.println("                    ⚔️ BATALLA                           ");
        System.out.println("╚══════════════════════════════════════════════════════╝");
        System.out.println("🏙️ Ciudad: " + ciudadNombre);
    ...
    public void mostrarReclutamiento(String unidad, String civilizacion, int costo) {
        System.out.println("\n🛠️ Reclutando " + unidad + " de " + civilizacion + "...");
        try {
            Thread.sleep(1000);
        } catch (InterruptedException e) {
            Thread.currentThread().interrupt();
    ...
    public void mostrarDespedida() {
        ...
        System.out.println("🏛️ Que la historia te guíe en tu próxima aventura.\n");
    }
}